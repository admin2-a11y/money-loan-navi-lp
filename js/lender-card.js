(() => {
  ...
  const lockedMobitDiagnosisCopy = Object.freeze({
    usage: Object.freeze({
      firstTime: "SMBCモビットは、スマホから借入までWEB完結。手続きがカンタンなので、カードローンがはじめてのあなたにおすすめです。",
    ...
    amount: Object.freeze({
      ...
      "30_50": "SMBCモビットは、あなたの希望する30～50万円程度の借入にも検討しやすいサービスです。まとまった資金が必要な場合にも検討しやすく、借入額の融通がききやすいのもポイントです。",
    ...
    priority: Object.freeze({
      ...
      privacy: "SMBCモビットは、WEB完結申込なら原則、電話連絡・郵送物なし。お申し込み前のやり取りが少なめなので、周囲に知られにくい設計です。",
  ...
  const diagnosisComments = (lender) => {
    ...
    const focusedAmountCopy = {
      promise: `プロミスは、あなたが希望する30～50万円程度の借入にも検討しやすいサービスです。借入額の融通がききやすい点も検討材料になります。`,
      aiful: `アイフルは、あなたが希望する30～50万円程度の借入にも検討しやすいサービスです。借入額の融通がききやすい点も検討材料になります。`
    };
